...
namespace Services.Data
{
  public class PrivacyService : IPrivacyService
  {
    ...
    public async Task UpdateAsync(Privacy privacyToBeUpdated, Privacy privacy)
    {
      ...
      privacyToBeUpdated.Heading = privacy.Heading ?? privacyToBeUpdated.Heading;
      privacyToBeUpdated.SubHeading = privacy.SubHeading ?? privacyToBeUpdated.SubHeading;
      privacyToBeUpdated.Body = privacy.Body ?? privacyToBeUpdated.Body;
      privacyToBeUpdated.BodySubHeading = privacy.BodySubHeading ?? privacyToBeUpdated.BodySubHeading;
      privacyToBeUpdated.Footer = privacy.Footer ?? privacyToBeUpdated.Footer;
