...
namespace Services.Data
{
    public class SocialMediaService : ISocialMediaService
    {
        ...
        public async Task UpdateAsync(SocialMedia socialMediaToBeUpdated, SocialMedia socialMedia)
        {
            ...
            socialMediaToBeUpdated.Name = socialMedia.Name != null ? socialMedia.Name : socialMediaToBeUpdated.Name;
            socialMediaToBeUpdated.Icon = socialMedia.Icon != null ? socialMedia.Icon : socialMediaToBeUpdated.Icon;
            socialMediaToBeUpdated.Link = socialMedia.Link != null ? socialMedia.Link : socialMediaToBeUpdated.Link;
