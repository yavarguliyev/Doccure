...
namespace Services.Data
{
  public class DoctorSocialMediaUrlLinkService : IDoctorSocialMediaUrlLinkService
  {
    ...
    public async Task UpdateAsync(DoctorSocialMediaUrlLink urlLinkToBeUpdated, DoctorSocialMediaUrlLink urlLink)
    {
      ...
      urlLinkToBeUpdated.FacebookURL = urlLink.FacebookURL ?? urlLinkToBeUpdated.FacebookURL;
      urlLinkToBeUpdated.TwitterURL = urlLink.TwitterURL ?? urlLinkToBeUpdated.TwitterURL;
      urlLinkToBeUpdated.InstagramURL = urlLink.InstagramURL ?? urlLinkToBeUpdated.InstagramURL;
      urlLinkToBeUpdated.PinterestURL = urlLink.PinterestURL ?? urlLinkToBeUpdated.PinterestURL;
      urlLinkToBeUpdated.LinkedinURL = urlLink.LinkedinURL ?? urlLinkToBeUpdated.LinkedinURL;
