  ...
  public class MappingProfiles : Profile
  {
    ...
    public MappingProfiles()
    {
      CreateMap<User, UserDTO>()
          ...
          .ForMember(x => x.Photo, opt => opt.MapFrom(src => src.Photo ?? cloudinary + "avatar_vpbhfa.png"))
      ...
      CreateMap<Blog, BlogDTO>()
          .ForMember(x => x.Photo, opt => opt.MapFrom(src => src.Photo ?? cloudinary + "blog-01_vffzcg.jpg"))
      ...
      CreateMap<SettingPhoto, SettingPhotoDTO>()
          .ForMember(x => x.Photo, opt => opt.MapFrom(src => src.Photo ?? cloudinary));

      CreateMap<Speciality, SpecialityDTO>()
          .ForMember(x => x.Photo, opt => opt.MapFrom(src => src.Photo ?? cloudinary + "specialities-01_aieefa.png"));

      CreateMap<Feature, FeatureDTO>()
          .ForMember(x => x.Photo, opt => opt.MapFrom(src => src.Photo ?? cloudinary + "feature-01_ejdasv.jpg"));
